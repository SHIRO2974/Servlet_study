...
public class UserServlet2 extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        users.add(new User(0, "aaa", "1111", "aaaaaa", "aaaa@gmail.com"));
        users.add(new User(0, "bbb", "1111", "bbbbbb", "bbbb@gmail.com"));
        users.add(new User(0, "ccc", "1111", "cccccc", "cccc@gmail.com"));
        users.add(new User(0, "ddd", "1111", "dddddd", "dddd@gmail.com"));
